...
<h3 align="center">Welcome to the System-Optimiser project! 😍<br>
We appreciate your interest in contributing.😊<br> </h3>

First off, thank you for considering contributing to **System-Optimiser!** We're excited to have you join our community. Every contribution, no matter how small, helps us build the best academic resource platform for students.
...
We expect all contributors to follow our [`Code of Conduct`](https://github.com/Kanwaljeet1/System-Optimiser/blob/main/docs/CodeOfConduct.md).
...
By contributing to this project, you agree that your contributions will be licensed under the [`MIT License`](https://github.com/Kanwaljeet1/System-Optimiser/blob/main/docs/LICENSE.md).
...
* ⌛ Reviews may take **24–72 hours** depending on activity. Thanks for your patience!
 ...
 > For Any Query, Send DM on LinkedIn [Kanwaljeet Kaur](https://www.linkedin.com/in/kanwaljeetkaur/).
...
- Take a look at the existing [Issues](https://github.com/Kanwaljeet1/System-Optimiser/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/Kanwaljeet1/System-Optimiser/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
...
<p align="center"> You can refer to the following articles on basics of Git and Github, in case you are stuck: <br>
...
This **CONTRIBUTING.md** was prepared with **❤️** by **Divya Jain** for **System-Optimiser** as part of the **NSoC'26 program.**
...
<h3 align="center">
Thank you for contributing to System-Optimiser 🌟
<br>
